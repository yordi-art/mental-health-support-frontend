...
import { appointments, therapists } from '../../data/sampleData';
          ...
          {upcoming.map(a => (
            <div key={a.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="text-xs border border-red-100 text-red-500 px-3 py-1.5 rounded-lg hover:bg-red-50 transition">Cancel</button>
              </div>
            </div>
          ))}
        </div>
