      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-slate-900 rounded-2xl overflow-hidden aspect-video relative flex items-center justify-center mb-4">
          <div className="text-center text-white">
            <div className="w-20 h-20 rounded-full bg-primary/30 flex items-center justify-center mx-auto mb-3">
              <Video size={32} className="text-white" />
            </div>
            <p className="font-semibold">Dr. Sarah Mengistu</p>
          ...
          {/* Timer */}
          <div className="absolute top-4 left-4 bg-black/40 text-white text-xs px-3 py-1 rounded-full">00:00</div>
        </div>
        {/* Controls */}
