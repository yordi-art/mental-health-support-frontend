      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white/15 backdrop-blur-md rounded-2xl border border-white/20 p-7 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="bg-error/20 border border-error/40 text-white text-sm rounded-xl px-4 py-2.5">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-white text-primary py-3 rounded-xl font-semibold flex items-center justify-center gap-2
                hover:bg-white/90 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-white/50
                transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed shadow-lg mt-2"
            >
              {loading ? (
